...
int xprev = 205; // Forecast point x-axis
//int x0 = 205;
//int x1 = 195;
//int x2 = 185;
//int x3 = 175;
...
int yprev = 110; // Forecast point y-axis. yprev should be defined as the first sensor value received.
//int y0y = 190;
//int y1y = 110;
//int y2y = 110;
//int y3 = 110;
...
int listx[19] = {205, 195, 185, 175, 165, 155, 145, 135, 125, 115, 105, 95, 85, 75, 65, 55, 45, 35, 25};
int listy[19] = {190, 110, 110, 110, 190, 190, 190, 190, 190, 190, 190, 190, 190, 190, 190, 190, 190, 190, 190};
...
// Draw a white circle
  ...
  delay(30);
  tft.drawCircle(120, 120, 114, WHITE);
  delay(30);
  tft.drawCircle(120, 120, 113, WHITE);
  delay(40);
  tft.drawCircle(120, 120, 112, WHITE);
//  delay(30);
//  tft.drawCircle(120, 120, 111, WHITE);
//  delay(30);
//  tft.drawCircle(120, 120, 110, WHITE);  
//  delay(30);
// tft.drawCircle(120, 120, 109, WHITE);
//  delay(15);
//  tft.drawCircle(120, 120, 108, WHITE);
//  delay(15);
//  tft.drawCircle(120, 120, 107, WHITE);

  delay(60);

//  tft.drawCircle(120, 120, 106, BLACK); 
//  delay(10);
//  tft.drawCircle(120, 120, 107, BLACK);
//  delay(10); 
//  tft.drawCircle(120, 120, 108, BLACK); 
//  delay(10);  
//  tft.drawCircle(120, 120, 109, BLACK);
//  delay(30);
//  tft.drawCircle(120, 120, 110, BLACK);
//  delay(30);
  tft.drawCircle(120, 120, 111, BLACK);
  delay(40);
  tft.drawCircle(120, 120, 112, BLACK);
  delay(30); 
  tft.drawCircle(120, 120, 113, BLACK);
  delay(30); 
  ...
  tft.drawCircle(120, 120, 121, BLACK);
  ...
  // Draw the 2 lowest lines
  tft.drawFastHLine(98, 231, 7, WHITE); // Left
  tft.drawPixel(97, 231, GREY);
  tft.drawFastHLine(134, 231, 7, WHITE); // Right
  tft.drawPixel(141, 231, GREY);
//  delay(300);
  
  // Draw the 2 middle lines
  tft.drawFastHLine(85, 228, 20, GREY); // Left
  tft.drawPixel(84, 228, DKGREY);
  tft.drawFastHLine(134, 228, 20, GREY); // Right
  tft.drawPixel(155, 225, DKGREY);
//  delay(200);
  
  // Draw the 2 upper lines
  tft.drawFastHLine(75, 225, 30, DKGREY); // Left
  tft.drawFastHLine(134, 225, 30, DKGREY); // Right
//  delay(100);
...
// Draw the 2 lines below the date
  tft.drawFastHLine(162, 205, 30, DKGREY);
//  delay(50);
  tft.drawFastHLine(162, 208, 25, DKGREY);
//  delay(25);
...
/////////////////  2. Time & date  ///////////////// 
    ...
    // Refresh the time
    tft.fillRect(56, 196, 100, 15, BLACK);
  ...
  //  // Hide secondes
  //  tft.fillRect(186, 196, 30, 20, BLACK);
  //  tft.drawCircle(120, 120, 119, WHITE);
    ...
    //Get a time structure to recover month and year
    ...
    // Refresh the date
    // tft.fillRect(60, 195, 48, 15, GREEN);
    tft.fillRect(162, 196, 30, 8, BLACK);
...
/////////////////  3. Glucose graph  ///////////////// 
    ...
    tft.fillRect(23, 54, 5, 134, BLACK);
    tft.fillRect(25, 188, 4, 2, BLACK);
    tft.fillRect(25, 190, 190, 3, BLACK);

    // Draw the new points
    for (int j = 1; j <= 18; j++)
    { // Define points color depending on their "y" values
      color = WHITE;
      if (listy[j] <= 100)
      { // The 100th pixel correspond to 140mMol
        color = RED;
      }
      if (listy[j] >= 150 && listy[j] < 190)
      { // The 150th pixel correspond to 90mMol
        color = TEAL;
      }
      if (listy[j] == 190)
      { // The 190th pixel correspond to 50mMol
        color = BLACK;
      }

      // Draw points from x0 = 190 to x19 = 25
    ...
    // Define high and low limits of yprev
    if (yprev > 188)
    ...
    // Draw the new forecast point [xprev, yprev]
    ...
    { // Define lines color
      color = WHITE;
      if (listy[k] <= 100) // Define line color
      { // The 100th pixel correspond to 140mMol
        color = RED;
      }
      if (listy[k] >= 150 && listy[k] < 190)
      { // The 150th pixel correspond to 90mMol
        color = TEAL;
      }
      if (listy[k] == 190)
      ...
      // Draw the new lines between all points
      tft.drawLine(listx[k], listy[k], listx[k + 1], listy[k + 1], color);
    }

    // Draw the new line between listy[1] and forecast point
